import { DoneGirlStyle } from "./doneGirl.styles";

export default function DoneGirl(props: any) {
  return (
    <DoneGirlStyle>
      <svg className={props.class} viewBox="0 0 1500 1600">
        <defs>
          <linearGradient
          ...
          >
            <stop
              ...
              offset="0%"
              stopColor="rgb(255,80,83)"
            />
            <stop
              id="log-in-girl-7-ellipse1-fill-1"
              offset="100%"
              stopColor="rgb(240,255,187)"
            />
          </linearGradient>
          <linearGradient
          ...
          >
            <stop
              ...
              offset="0%"
              stopColor="rgb(200,142,218)"
            />
            <stop
              id="log-in-girl-7-ellipse4-fill-1"
              offset="100%"
              stopColor="rgb(238,237,237)"
            />
          </linearGradient>
          <linearGradient
          ...
          >
            <stop
              ...
              offset="0%"
              stopColor="rgb(255,218,224)"
            />
            <stop
              id="log-in-girl-7-ellipse7-fill-1"
              offset="100%"
              stopColor="rgb(254,255,246)"
            />
          </linearGradient>
          <linearGradient
          ...
          >
            <stop
              ...
              offset="0%"
              stopColor="rgb(156,179,239)"
            />
            <stop
              id="log-in-girl-7-path8-fill-1"
              offset="100%"
              stopColor="rgb(186,211,246)"
            />
          </linearGradient>
          <linearGradient
          ...
          >
            <stop
              ...
              offset="0%"
              stopColor="rgb(13,18,30)"
            />
            <stop
              id="log-in-girl-7-polygon1-fill-1"
              offset="78%"
              stopColor="rgb(44,82,170)"
            />
          </linearGradient>
          <linearGradient
          ...
          >
            <stop
              ...
              offset="51%"
              stopColor="rgb(3,10,22)"
            />
            <stop
              id="log-in-girl-7-path9-fill-1"
              offset="100%"
              stopColor="rgb(92,79,144)"
            />
          </linearGradient>
          <linearGradient
          ...
          >
            <stop
              ...
              offset="0%"
              stopColor="rgb(223,94,85)"
            />
            <stop
              id="log-in-girl-7-path18-fill-1"
              offset="100%"
              stopColor="rgb(243,172,154)"
            />
          </linearGradient>
          <linearGradient
          ...
          >
            <stop
              ...
              offset="0%"
              stopColor="rgb(8,18,33)"
            />
            <stop
              id="log-in-girl-7-path19-fill-1"
              offset="51%"
              stopColor="rgb(56,44,44)"
            />
            <stop
              id="log-in-girl-7-path19-fill-2"
              offset="100%"
              stopColor="rgb(88,70,127)"
            />
          </linearGradient>
          <linearGradient
          ...
          >
            <stop
              ...
              offset="0%"
              stopColor="rgb(45,110,245)"
            />
            <stop
              id="log-in-girl-7-path24-fill-1"
              offset="49%"
              stopColor="rgb(10,18,32)"
            />
          </linearGradient>
          <linearGradient
          ...
          >
            <stop
              ...
              offset="0%"
              stopColor="rgb(12,6,16)"
            />
            <stop
              id="log-in-girl-7-path42-fill-1"
              offset="100%"
              stopColor="rgb(87,61,61)"
            />
          </linearGradient>
          <radialGradient
          ...
          >
            <stop
              ...
              offset="0%"
              stopColor="rgb(0,9,19)"
            />
            <stop
              id="log-in-girl-7-path43-fill-1"
              offset="100%"
              stopColor="rgb(42,103,227)"
            />
          </radialGradient>
          <radialGradient
          ...
          >
            <stop
              ...
              offset="0%"
              stopColor="rgb(58,136,212)"
            />
            <stop
              id="log-in-girl-7-path44-fill-1"
              offset="100%"
              stopColor="rgb(22,74,162)"
            />
          </radialGradient>
          <radialGradient
          ...
          >
            <stop
              ...
              offset="0%"
              stopColor="rgb(159,94,192)"
            />
            <stop
              id="log-in-girl-7-path50-fill-1"
              offset="100%"
              stopColor="rgb(196,153,213)"
            />
          </linearGradient>
          <linearGradient
          ...
          <radialGradient
            id="log-in-girl-7-path53-fill"
            cx="0"
            cy="0"
            r="0.500000"
            spreadMethod="pad"
            gradientUnits="objectBoundingBox"
            gradientTransform="matrix(1 0 0 1 0.50000000000000 0.50000000000000)"
          >
            <stop
              id="log-in-girl-7-path53-fill-0"
              offset="50%"
              stopColor="rgb(45,110,245)"
            />
            <stop
              id="log-in-girl-7-path53-fill-1"
              offset="100%"
              stopColor="rgba(45,110,245,0)"
            />
          </radialGradient>
        </defs>
        ...
        <g id="log-in-girl-7-stroke-3">
          <path
            ...
            strokeDashoffset="5972"
            strokeDasharray="600,4772"
          />
          <path
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeDashoffset="5172"
            strokeDasharray="200,4772"
          />
        </g>
        <g
          id="log-in-girl-7-stroke"
          transform="matrix(1.02642185997495 0.15828387988745 -0.13681439064772 0.88719888228561 74.01594636017512 29.16899038140934)"
        >
          <path
          ...
          <path
            ...
            strokeLinecap="round"
            strokeDashoffset="80"
            strokeDasharray="80,3663"
          />
        </g>
        <g
          id="log-in-girl-7-character_to"
          transform="translate(778.790115,814.400955)"
        >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <g
                      id="log-in-girl-7-l-arm_tr"
                      transform="rotate(18.682774)"
                    >
                      <g
              ...
              <g id="log-in-girl-7-vision">
                <g
                  id="log-in-girl-7-animation-group"
                  transform="matrix(1.38490047825291 -0.14663662683877 0.12257968528205 1.75297116907137 -659.54013434685385 -245.37830662248075)"
                >
                  <path
                    id="log-in-girl-7-path53"
                    d="M969.793970,500C969.793970,372.860720,1072.860720,269.793970,1200,269.793970C1327.139280,269.793970,1430.206030,372.860720,1430.206030,500C1430.206030,627.139280,1327.139280,730.206030,1200,730.206030C1072.860720,730.206030,969.793970,627.139280,969.793970,500Z"
                    opacity="0.3"
                    fill="url(#log-in-girl-7-path53-fill)"
                    stroke="none"
                    strokeWidth="0"
                  />
                  <rect
                    id="log-in-girl-7-square"
                    width="100"
                    height="100"
                    rx="50"
                    ry="50"
                    transform="matrix(2 0 0 2 1100 400)"
                    opacity="0.3"
                    fill="rgb(45,110,245)"
                    stroke="rgb(45,110,245)"
                    strokeWidth="0"
                  />
                  <g
                    id="log-in-girl-7-mask-group2"
                    mask="url(#log-in-girl-7-masks2)"
                  >
                    <g
                      id="log-in-girl-7-keyframes_to"
                      transform="translate(1200,500.000504)"
                    >
                      <g id="log-in-girl-7-keyframes_ts" transform="scale(1,1)">
                        <g
                          id="log-in-girl-7-keyframes"
                          transform="translate(-1200,-500.000504)"
                        >
                          <rect
                            id="log-in-girl-7-rect2"
                            width="383.347080"
                            height="60.855873"
                            rx="0"
                            ry="0"
                            transform="matrix(1 0 0 1 1916.07810191164731 648.42477646571115)"
                            fill="rgb(0,122,184)"
                            stroke="none"
                            strokeWidth="0"
                          />
                          <rect
                            id="log-in-girl-7-rect3"
                            width="383.347080"
                            height="60.855873"
                            rx="0"
                            ry="0"
                            transform="matrix(1 0 0 1 1507.75499634037442 645.33406537874851)"
                            fill="rgb(0,122,184)"
                            stroke="none"
                            strokeWidth="0"
                          />
                          <rect
                            id="log-in-girl-7-keyframe"
                            width="99.547516"
                            height="99.547516"
                            rx="0"
                            ry="0"
                            transform="matrix(0.70710678118655 0.70710678118655 -0.70710678118655 0.70710678118655 2316.72527715628667 608.86777857332163)"
                            fill="rgb(32,226,255)"
                            stroke="none"
                            strokeWidth="0"
                          />
                          <rect
                            id="log-in-girl-7-keyframe2"
                            width="99.547516"
                            height="99.547516"
                            rx="0"
                            ry="0"
                            transform="matrix(0.70710678118655 0.70710678118655 -0.70710678118655 0.70710678118655 1908.40217158501628 605.77706748635899)"
                            fill="rgb(32,226,255)"
                            stroke="none"
                            strokeWidth="0"
                          />
                          <rect
                            id="log-in-girl-7-rect4"
                            width="232.604767"
                            height="60.855873"
                            rx="0"
                            ry="0"
                            transform="matrix(1 0 0 1 2201.17845804199351 299.23219906278638)"
                            fill="rgb(0,122,184)"
                            stroke="none"
                            strokeWidth="0"
                          />
                          <rect
                            id="log-in-girl-7-keyframe3"
                            width="99.547516"
                            height="99.547516"
                            rx="0"
                            ry="0"
                            transform="matrix(0.70710678118655 0.70710678118655 -0.70710678118655 0.70710678118655 2174.15316068926359 258.09381622355210)"
                            fill="rgb(32,226,255)"
                            stroke="none"
                            strokeWidth="0"
                          />
                          <rect
                            id="log-in-girl-7-keyframe4"
                            width="99.547516"
                            height="99.547516"
                            rx="0"
                            ry="0"
                            transform="matrix(0.70710678118655 0.70710678118655 -0.70710678118655 0.70710678118655 2451.08332031108148 259.67520117039845)"
                            fill="rgb(32,226,255)"
                            stroke="none"
                            strokeWidth="0"
                          />
                          <g
                            id="log-in-girl-7-keyframe5_ts"
                            transform="translate(1507.409843,604.590103) rotate(45) scale(0,0)"
                          >
                            <rect
                              id="log-in-girl-7-keyframe5"
                              width="99.547516"
                              height="99.547516"
                              rx="0"
                              ry="0"
                              transform="translate(-0.004623,0.004494)"
                              fill="rgb(32,226,255)"
                              stroke="none"
                              strokeWidth="0"
                            />
                          ...
                          <rect
                            id="log-in-girl-7-rect5"
                            width="719.176951"
                            height="60.855873"
                            rx="0"
                            ry="0"
                            transform="matrix(1 0 0 1 1601.41925448989537 475.06866541467753)"
                            fill="rgb(0,122,184)"
                            stroke="none"
                            strokeWidth="0"
                          />
                          <rect
                            id="log-in-girl-7-keyframe6"
                            width="99.547516"
                            height="99.547516"
                            rx="0"
                            ry="0"
                            transform="matrix(0.70710678118655 0.70710678118655 -0.70710678118655 0.70710678118655 2319.53171926181903 433.24087229150194)"
                            fill="rgb(32,226,255)"
                            stroke="none"
                            strokeWidth="0"
                          />
                          <rect
                            id="log-in-girl-7-rect6"
                            width="383.347080"
                            height="60.855873"
                            rx="0"
                            ry="0"
                            transform="matrix(1 0 0 1 1200.35160083913865 470.35333019352225)"
                            opacity="0"
                            fill="rgb(0,122,184)"
                            stroke="none"
                            strokeWidth="0"
                          />
                          <rect
                            id="log-in-girl-7-keyframe7"
                            width="99.547516"
                            height="99.547516"
                            rx="0"
                            ry="0"
                            transform="matrix(0.70710678118655 0.70710678118655 -0.70710678118655 0.70710678118655 1600.99877608378051 430.79633230113274)"
                            fill="rgb(32,226,255)"
                            stroke="none"
                            strokeWidth="0"
                          />
                          <g
                            id="log-in-girl-7-keyframe8_ts"
                            transform="translate(1200.006447,429.609368) rotate(45) scale(0,0)"
                          >
                            <rect
                              id="log-in-girl-7-keyframe8"
                              width="99.547516"
                              height="99.547516"
                              rx="0"
                              ry="0"
                    ...
                    <g
                      id="log-in-girl-7-pen_to"
                      transform="translate(1200,500)"
                    >
                      <g id="log-in-girl-7-pen_tr" transform="rotate(360)">
                        <g
                          id="log-in-girl-7-pen_ts"
                          transform="scale(0.340932,0.340932)"
                        >
                          <g
                            id="log-in-girl-7-pen"
                            transform="translate(-280.831612,-493.872360)"
                          >
                            <path
                              id="log-in-girl-7-ellipse11"
                              d="M27.053224,-0.002670L-0.109071,-49.935280L-27.090006,-0.000010C-27.090006,-0.000010,-16.450006,17.409990,-16.450006,33.839990L16.409994,33.839990C16.409994,17.409990,27.049994,-0.000010,27.049994,-0.000010Q27.049994,-0.000010,27.049994,-0.000010L-0.111378,-49.934814Q-0.111378,-49.934814,0.004403,-6.761700C3.555594,-6.761700,6.430000,-3.733445,6.430000,0C6.430000,3.733445,3.551191,6.760000,0,6.760000C-3.551191,6.760000,-6.430000,3.733445,-6.430000,0C-6.430000,-3.733445,-3.546788,-6.761700,0.004403,-6.761700"
                              transform="matrix(1 0 0 1 280.85000610351563 490.51000976562500)"
                              fill="none"
                              stroke="rgb(255,255,255)"
                              strokeWidth="5"
                              strokeLinecap="round"
                              strokeDashoffset="359.620000"
                              strokeDasharray="359.620000"
                            />
                            <path
                              id="log-in-girl-7-path54"
                              d="M264,529.910000L297.700000,529.910000C300.952957,529.910000,303.590000,532.547043,303.590000,535.800000L303.590000,547.170000L258.070000,547.170000L258.070000,535.800000C258.069964,534.230920,258.696003,532.726681,259.809259,531.620935C260.922515,530.515189,262.430956,529.899344,264,529.910000Z"
                              fill="none"
                              stroke="rgb(45,110,245)"
                              strokeWidth="6"
                              strokeLinecap="round"
                              strokeDashoffset="120.510000"
                              strokeDasharray="120.510000"
                            />
                          </g>
                        </g>
                      </g>
                    ...
                    <g
                      id="log-in-girl-7-triangle_to"
                      transform="translate(1200,500)"
                    >
                      <g
                        id="log-in-girl-7-triangle_ts"
                        transform="rotate(90) scale(1,1)"
                      >
                        <polygon
                          id="log-in-girl-7-triangle"
                          points="0,-44.721360 38.729833,22.360680 -38.729833,22.360680 0,-44.721360"
                          transform="translate(0,0)"
                          fill="rgb(45,110,245)"
                          stroke="none"
                          strokeWidth="0"
                    ...
                    <mask id="log-in-girl-7-masks2" mask-type="luminance">
                      <rect
                        id="log-in-girl-7-square2"
                        width="100"
                        height="100"
                        rx="50"
                        ry="50"
                  ...
                  <g
                    id="log-in-girl-7-stroke-path_tr"
                    transform="translate(1200,500) rotate(270)"
                  >
                    <g
                      id="log-in-girl-7-stroke-path_ts"
                      transform="scale(2.075390,2.075390)"
                    >
                      <ellipse
                        id="log-in-girl-7-stroke-path"
                        rx="55"
                        ry="55"
                        transform="translate(0,0)"
                        fill="none"
                        stroke="rgb(45,110,245)"
                        strokeWidth="4"
                        strokeDasharray="345.580000,287.983300"
                      />
                    </g>
                  </g>
                </g>
        ...
        <path
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeDashoffset="2843"
          strokeDasharray="120,2603"
        />
        <path
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeDashoffset="2663"
          strokeDasharray="30,2603"
        />
        ...
        <g
          id="log-in-girl-7-g1"
          transform="matrix(0.89136222829801 -0.16915094084784 0.16915094084784 0.89136222829801 -93.86559111404028 246.23042670799396)"
        >
          <path

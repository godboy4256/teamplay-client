...
export default function Project() {
    ...
    const { data: positionData } = useQuery<Pick<IQuery,"fetchPositions">>(FETCH_POSITIONS)
    const { data: locationData } = useQuery<Pick<IQuery,"fetchLocations">>(FETCH_LOCATION)
    const { data: typesData } = useQuery<Pick<IQuery,"fetchTypes">>(FETCH_TYPES)
    const { data: platformsData } = useQuery<Pick<IQuery,"fetchPlatforms">>(FETCH_PLATFORMS)

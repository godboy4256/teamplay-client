...
| 석지웅 | 프론트엔드  | 1. 프로젝트 CRUD 리스트 페이지<br>2. 프로젝트 관리 CRUD( 관리 게시판 , 투두리스트 )<br>3. 메인 페이지<br>4. 레이아웃 헤더<br>5. 포인트 충전 및 반환<br>6. 캐러셀 슬라이드 및 버튼,인풋 등 공용 컴포넌트 제작<br>7. 담당 페이지 반응형 <br>8.                                                                   
